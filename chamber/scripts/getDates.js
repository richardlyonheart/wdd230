...
const weatherForcast = 'https://api.openweathermap.org/data/2.5/forecast/daily?lat=29.30&lon=94.80&cnt=3&appid=241fe8e53ef22c16a2d5eb0155bed395&units=imperial';
async function apiFetch() {
  ...
  function displayResults(data) {
    ...
    apiFetch(weatherForcast);

    function displayForcast(data) {
      forcastTemp.innerHTML = `${list.temp.day.toFixed(0)}&deg;F`;
